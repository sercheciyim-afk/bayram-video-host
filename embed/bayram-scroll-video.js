(function () {
  ...
  function addStyles() {
    ...
    style.textContent =
      ...
      ".bayram-scroll-video__button{display:inline-flex;align-items:center;justify-content:center;gap:16px;min-width:340px;min-height:64px;margin-top:5vh;padding:18px 38px;border:1px solid rgba(255,255,255,.42);border-radius:999px;background:rgba(255,255,255,.28);color:#17231d;font-family:Evolventa,Arial,sans-serif;font-size:20px;font-weight:600;line-height:1;text-decoration:none;letter-spacing:0;box-shadow:0 18px 44px rgba(55,64,35,.08);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);pointer-events:auto;transition:background-color .18s ease,color .18s ease,transform .18s ease;}" +
      ".bayram-scroll-video__button:hover{background:rgba(255,255,255,.72);transform:translateY(-1px);}" +
      ...
      ".bayram-scroll-video__arabic{margin:0 0 5.2vh;font-size:clamp(42px,12vw,58px);line-height:1.05;letter-spacing:2px;color:#fff;text-shadow:0 2px 22px rgba(0,0,0,.24);}" +
      ".bayram-scroll-video__title{font-size:clamp(54px,16vw,84px);line-height:.88;color:#fff;text-shadow:0 2px 24px rgba(0,0,0,.24);white-space:nowrap;}" +
      ".bayram-scroll-video__title br{display:none;}" +
      ".bayram-scroll-video__subtitle{max-width:360px;margin:4.2vh auto 0;font-size:clamp(22px,6vw,32px);line-height:1.35;color:#fff;text-shadow:0 2px 20px rgba(0,0,0,.24);}" +
      ".bayram-scroll-video__button{width:min(82vw,360px);min-width:0;min-height:58px;margin-top:5.2vh;padding:16px 26px;border-color:rgba(255,255,255,.72);background:rgba(255,255,255,.1);color:#fff;font-size:clamp(19px,5.2vw,25px);text-shadow:0 1px 16px rgba(0,0,0,.2);box-shadow:none;}" +
